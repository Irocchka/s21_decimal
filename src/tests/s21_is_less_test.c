...
START_TEST(is_less_check_1) {
  // input
  s21_decimal dec1 = {{0, 0, 0, 0}};
  s21_decimal dec2 = {{0, 0, 0, 0}};
  // act
  int work = s21_is_less(dec1, dec2);
  // res
  int wanted = 0;
...
Suite* s21_is_less_suite() {
  ...
  tcase_add_test(tc, is_less_check_1);
  tcase_add_test(tc, is_less_check_2);
  tcase_add_test(tc, is_less_check_3);
  tcase_add_test(tc, is_less_check_4);
  tcase_add_test(tc, is_less_check_5);
  tcase_add_test(tc, is_less_check_6);
  tcase_add_test(tc, is_less_check_7);
  tcase_add_test(tc, is_less_check_8);
  tcase_add_test(tc, is_less_check_9);
  tcase_add_test(tc, is_less_check_10);
